$(function () {
    ...
    $('#btnOdevVer').click(function () {
        ...
        var odevAciklama = $('#txtAciklama').val();
        var odevGonderimi = $('#cmbOdevGonderimi').val();
        var dosyaID = $('#cmbDosyalardanDosya').val();
        ...
        console.log('DersID=' + DersID + '&Baslik=' + encodeURIComponent(odevBaslik) + '&OdevGonderimi=' + odevGonderimi + '&DosyaID=' + dosyaID + '&Aciklama=' + encodeURIComponent(odevAciklama));
        $.ajax({
            type: 'POST',
    ...
    $('.btnOdevGonderisiIncelendi').click(function () {

        var dugme = $(this);
        var OdevGonderiID = $(this).attr('data-OdevGonderiID');

        $.ajax({
            type: 'POST',
            url: '/Ajax/Odev/OdevGonderiBilgisiKaydet',
            data: "OdevGonderiID=" + OdevGonderiID + "&Durum=2",
            success: function (msg) {
                var tr = $(dugme).closest('tr');
                tr.remove();
    ...
    function FormuTemizle() {
        ...
        var $select = $('#cmbDosyalardanDosya').selectize();
        var control = $select[0].selectize;
        control.clear();

        var $select2 = $('#cmbDersID').selectize();
