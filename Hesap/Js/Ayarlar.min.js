...
$('#btnAbonelikEkle').click(function () {

    var dogrulamaKodu = '';

    dogrulamaKodu = prompt("Doğrulama Kodunu Giriniz", "");
    if (dogrulamaKodu != null) {
        $.ajax({
            type: 'POST',
            url: '/Ajax/Hesap/AbonelikEkle',
            data: "DogrulamaKodu=" + dogrulamaKodu,
            success: function (msg) {

                MesajKutusu('Abonelik Başarıyla Eklendi');
            },
            error: function (msg) {

                HataMesaji('Doğrulama Kodu Hatalı');
            }
        });
    }
