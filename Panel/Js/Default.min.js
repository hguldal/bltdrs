    ...
    $('#odevVerbtnOdevVer').click(function () {
        ...
        var odevGonderimi = $('#odevVercmbOdevGonderimi').val();
        var dosyaID = $('#odevVercmbDosyalardanDosya').val();
    ...
    function OdevFormuTemizle() {
        ...
        var $select = $('#odevVercmbDosyalardanDosya').selectize();
    ...
    var $OdevVerdosyalar = $('#odevVercmbDosyalardanDosya').selectize({
    ...
    $('#dosyaPaylasbtnDosyaEkle').click(function () {
        ...
        var DersID = $('#dosyaPaylasodevVercmbDersID').val();
    ...
    function DosyayiVeritabaninaKaydetVeDerstePaylas(dersID, dosyaAdi, dosyaBoyut, dosyaTuru, azureDosyaAdi, aciklama) {
        console.log('/Ajax/Dosya/Ekle?AzureDosyaAdi=' + azureDosyaAdi + '&Aciklama=' + aciklama + '&DosyaBoyut=' + dosyaBoyut + '&DosyaAdi=' + encodeURIComponent(dosyaAdi) + '&DosyaTuru=' + dosyaTuru + '&Konum=' + '-1');
        $.ajax({
            type: 'POST',
            dataType: 'json',
