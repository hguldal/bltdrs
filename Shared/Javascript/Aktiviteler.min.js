$(document).ready(function () {
    ...
    $('body').on('click', '.btnGoruntuleyenleriGoster', function () {
        $('#modalKisiDetaylari').attr('data-AktiviteID', $(this).attr('data-AktiviteID'));
        $('#modalKisiDetaylari').attr('data-tip', 'goruntu');
        $('#modalKisiDetaylari').modal('show');

    });
    $('body').on('click', '.btnBegenenleriGoster', function () {
        $('#modalKisiDetaylari').attr('data-AktiviteID', $(this).attr('data-AktiviteID'));
        $('#modalKisiDetaylari').attr('data-tip', 'begeni');
        $('#modalKisiDetaylari').modal('show');

    });


    $('#modalKisiDetaylari').on('show.bs.modal', function (e) {
        var aktiviteID = $(this).attr('data-AktiviteID');
    ...
    $('.checkBoxOdevGonderimiAcKapa').change(function () {
        ...
        $.ajax({
            ...
            data: "pk=" + OdevID + "&name=" + alan + "&value=2",
            success: function (msg) {
