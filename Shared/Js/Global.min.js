...
function ProfilKucukKunyeHTML(UserID,Avatar,Unvan,Ad,Soyad,Onayli)
  {
      ...
      var html = '<span><img src="http://bulutders.blob.core.windows.net/profilresimleri/' + Avatar + '"  style="width:48px;height: 48px"> <a href="/Hesap/Profil?UserID=' + UserID +'"> ' + unvanHtml + ' ' + Ad + ' ' + Soyad + ' ' + onayliHtml + '</a></span>';
