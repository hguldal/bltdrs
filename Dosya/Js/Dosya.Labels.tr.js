var mesajlar = {
    ...
    dosyaayarlaribasariylakaydedildi:'Dosya ayarları başarıyla kaydedildi',
    dosyaayarlarikaydedilirkenhata:'Dosya ayarları kaydedilirken bir hata meydana geldi !',
    islemsirasindahata:'İşlem sırasında bir hata meydana geldi',
    kisiicinzatenerisimhakkivar:'Bu kişi dosyaya zaten erişebiliyor',
    kisizatensahip:'Erişim izni vermek istediğin kişi zaten bu dosyanın sahibi',
    erisimdurdurulacak:'Seçtiğin kişinin dosyaya olan erişimini durdurmak üzeresin. Emin misin ?',
