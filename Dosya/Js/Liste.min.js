   ...
   reader.onloadend = function (evt) {
    ...
    $('body').on('click', '.chkBoxOge', function () {
        ...
        $('.chkBoxOge').each(function (id, jd) {
            ...
            if (this.checked) {
                ...
                seciliOgeSayisi++;
                if ($(this).closest('tr').hasClass('KlasorSatiri')) {
    ...
    function VerilenDersleriGoster()
    {
              ...
              $.ajax({
                ...
                '</td>' +
                '<td>' +
                '<button class="btn btn-link lnkDersSecOge" data-DersID="' + res[i].DersID + '"><i class="fa fa-book fa-2x"></i>' + res[i].DersAdi + '</button>' +
                '</td>' +
